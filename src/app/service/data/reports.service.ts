...
export class ReportsService {
  ...
  getStockPositionByShopName(username, shopName, type, packagingType) {
    return this.httpClient.get(`${API_URL}/users/${username}/getStockPositionByCityName/${shopName}/${type}/${packagingType}`);
  }
